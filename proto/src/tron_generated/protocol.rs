...
#[derive(Clone, Copy, PartialEq, ::prost::Message)]
pub struct ZksnarkResponse {
    #[prost(enumeration = "zksnark_response::Code", tag = "1")]
    pub code: i32,
}
/// Nested message and enum types in `ZksnarkResponse`.
pub mod zksnark_response {
    #[derive(
        Clone,
        Copy,
        Debug,
